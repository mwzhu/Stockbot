...
end_date = datetime.strptime('2020-07-03', '%Y-%m-%d')
# Convert to unix for the API
start_date_ms = unix_time_millis(date)
end_date_ms = unix_time_millis(date)
...
consumer_key = '777LGZPGAKJ05KHAZQMYCIUTGNKH3P48'
